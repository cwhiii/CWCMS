<?php   
    ...
    function loadPage($aPage){
        // Validate ID.
        if (validateID($aPage)){
            $results = $_SESSION['DB']->query("SELECT p_id, name, content FROM pages WHERE p_id = $$aPage;");
    ...
    <div class="tools">
        ...
        <fieldset class="collapsible">	
            ...
            <div>
                ...
                <label for="name">Location </label>     <input class='labled' type="text" value="/some/url/is/specified/"  style="color:grey;"><br>
                <label for="name">ID:</label>           <?php echo "<input class='labled' type='text' name='id' size='3' value='" . $_SESSION['loadID'] . "' readonly style='color:grey;'><br>"; ?> 
                <label for="name">State:</label>        <?php echo "<input class='labled' type='text' name='state' size='8' value='" . $_SESSION['loadState'] . "' readonly style='color:grey;'><br>"; ?> 
            </div>			
        </fieldset>
        <fieldset  class="collapsible">
            <legend>Nav</legend>
